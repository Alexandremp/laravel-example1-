...
@section('content')
    ...
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb"> <a href="{{ url('admin/dashboard') }}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#">Categorys</a>
                <a href="#" class="current">Add Categorys</a> </div>
            <h1>Category</h1>
        </div>
